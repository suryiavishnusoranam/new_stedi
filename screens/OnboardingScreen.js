        ...
        pages={[
            {
              ...
              subtitle: (
                <View>
                  <Text style={{fontWeight:'bold', textAlign:'center', color:'#A0CE4E', fontSize:19, margin:12,  marginTop: -70}}>We value your privacy. Please share your phone number si we can track your balance.</Text>
                </View>
              ),
            },
            {
